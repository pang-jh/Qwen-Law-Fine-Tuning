...
```
## 配置训练yaml文件
- yaml文件位于 examples/train_lora/llama3_lora_sft.yaml
...
- 修改yaml文件，位于 examples/inference/llama3_lora_sft.yaml
```bash
...
```
- 执行推理命令 llamafactory-cli webchat examples/inference/llama3_lora_sft.yaml
